...
export default function AdminCouponDetailPage() {
  ...
  const loadOrders = async () => {
    try {
      const res = await apiClient.get(`/admin/coupons/${id}/orders`, {
  ...
  if (!coupon)
    return (
      <div className="text-sm text-muted-foreground">Coupon not found.</div>
    );
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Edit coupon details and view orders that used it.
        </p>
      </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setCoupon({
                    ...coupon,
                    type: e.target.value as typeof coupon.type,
                  })
                }
